...
word_label_main = tk.Label(main_frame, text="", font=("Arial", 16), width=40, height=2)
word_label = tk.Label(show_frame, text="", font=("Arial", 16), width=40, height=2)
meaning_label_main = tk.Label(main_frame, text="", font=("Arial", 1), width=40, height=2)
meaning_label = tk.Label(show_frame, text="", font=("Arial", 16), width=40, height=2)
show_button = tk.Button(main_frame, text="Translate", command=show_meaning_screen)
next_button = tk.Button(show_frame, text="Next", command=next_word)
forgot_button = tk.Button(show_frame, text="Forget", command=forgot_word)
add_word_button = tk.Button(main_frame, text="Add", command=add_new_word)
view_all_words_button = tk.Button(main_frame, text="View", command=view_all_words)
